...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('https://github.com/wasuaje', 'Github', 'icon-github'),
    ),
    "en": (
        ('/en/index.html', 'Home', 'icon-home'),
        ('/en/archive.html', 'Archives', 'icon-folder-open-alt'),
        ('/en/categorias/index.html', 'Tags', 'icon-tags'),
        ('/en/rss.xml', 'RSS', 'icon-rss'),
        ('http://wasuaje.com', 'About me', 'icon-user'),
        ('https://twitter.com/SysAdmVe', 'My Twitter', 'icon-twitter'),
        ('https://github.com/wasuaje', 'My Github', 'icon-github'),
    ),
}
